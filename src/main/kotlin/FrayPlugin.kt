...
class FrayPlugin : Plugin<Project> {
  override fun apply(target: Project) {
    ...
    val frayJvmti =
      target.dependencies.add("testImplementation", "cmu.pasta.fray:jvmti:$FRAY_VERSION:$os-$arch")
    val frayInstrumentation =
      target.dependencies.add("testImplementation", "cmu.pasta.fray:instrumentation:$FRAY_VERSION")
